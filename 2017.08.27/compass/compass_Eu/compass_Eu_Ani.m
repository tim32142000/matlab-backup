...
b2_per_ts = round( (2*pi/w_ext)/tau) ; % times steps in a period of the B field oscillation
gamma = 6.0 ; % dimensionless damping constant
b1 = 36.0 ; % dimensionless strength of fixed component of B field
b2 = 88.5 ; % dimensionless amplitude of oscillating component of B field. direction is prependicular to b1
Odiv = 3 ; % divide a circle to how many part. 1~3 is permissible in this program.
figure ;
...
switch Odiv
    case {1}
        for m = 1:tot_ts
            ...
            if (mod(m,b2_per_ts/50)==0 && m>0*b2_per_ts)
