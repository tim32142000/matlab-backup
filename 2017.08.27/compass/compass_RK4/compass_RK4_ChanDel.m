% caculating and plotting theta_n versus delta(initial phase of sinusoidal oscillatiing magnetic field)
...
B1 = 36.0 ;
B2 = 95.00 ;
Odiv = 360 ; % equally divide a circle to how many part
...
for n = 1:1
    ...
    plot(delta/pi*180*ones(1,300),theta_n(tot_time-299:tot_time)./pi.*180,'LineStyle','none','Marker','.','MarkerSize',6 )
